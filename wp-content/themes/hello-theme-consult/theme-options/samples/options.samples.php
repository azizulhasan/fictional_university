...
// custom meta box creation


CSF::createSection( $prefix, array(
  'id'=>'_portfolio_setting',
  'title'  => 'Potrfolio options',
  'post_type'=>'portfolio',
  'context'=>'normal',
  'priority'=>'high',
  'sections' => array(
    array(
      ...
      'fields'=>array(
        array(
          'id'=>'portfolio_field_1',
          'title'=>'',
          'type'=>'text'
        ),

        // custom meta box is no finished
...
/*-----------------------------------
  3. A Switcher section
------------------------------------*/
CSF::createSection( $prefix, array(
    array(
    'name'=>'switcher section',
    'title'  => 'Placeholder Switcher',
    'icon'   => 'fa fa-star',
    'fields' => array(
    array(
      'id'=>'reloader_on',
      'type'=>'switcher',
      'title'=>'placeholder on or off',
    )
     )
    )
  )
...
CSF::createSection($prefix,array(
  ...
  // create a section 1
CSF::createSection($prefix,array(
  'parent'=>'accordion_section',
  'id'=>'accordion_1',
  'title'=> 'acconrdion one',
  'icon'=>'fa fa-facebook',
  'fields'=>array(
    array(
      'id'=>'accordion_field_1',
      'title'=> 'heading',
      'type'=>'text',
    ),
    array(
      'id'=>'accordion_field_2',
      'title'=> 'heading',
      'type'=>'text',
    ),
...
CSF::createSection($prefix,array(
  'parent'=>'accordion_section',
  'id'=>'accordion_2',
  'title'=> 'acconrdion two',
  'icon'=>'fa fa-rocket',
  'fields'=>array(
    array(
      'id'=>'accordion_field_3',
      'title'=> 'heading',
      'type'=>'text',
    ),
    array(
      'id'=>'accordion_field_4',
      'title'=> 'heading',
      'type'=>'text',
    ),
