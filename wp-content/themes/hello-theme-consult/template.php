            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="looking_for_left para_default">
                        <h3 style="color:<?php                    
                            $options = get_option( 'consult_options' ); 
                            echo esc_html($options['head_color']); 
                            ?> ">

                            <?php                    
                            $options = get_option( 'consult_options' ); 
                            echo esc_html($options['opt_text']); 
                            ?>
                            </h3>
                       <p><?php                    
                            $options = get_option( 'consult_options' ); 
                            echo esc_html($options['opt_textarea']); 
                            ?>
                     </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="looking_for_right image_fulwidth wow fadeInRight" data-wow-delay="300ms">
                        <img height="300" width="100%" src="<?php                    
                            $options = get_option( 'consult_options' ); 
                            echo esc_url($options['slider_image']) ; 
                            ?> " alt="image">
	...
	<div class="why_choose_us_area">
        <div class="container">
            <div class="row">
                ...
                <?php 
                 $options = get_option( 'consult_options' ); 
                  $group_one=$options['field_group']; 
                            if(is_array($group_one)){
                            foreach ($group_one as $group_one_value) {?>
                                <div class="col-md-4 col-sm-6">
                                    <div class="choose_us_single para_default image_fulwidth text-center wow fadeInLeft" data-wow-delay="300ms">
                                        <img height="250px"; width="100%" src="
                                        <?php                    
                            $options = get_option( 'consult_options' ); 
                            echo esc_url($group_one_value['group_image']); 
                            ?> " alt="images">
                           <h3>
                            <?php                    
                            $options = get_option( 'consult_options' ); 
                            echo $group_one_value['group_text']; 
                            ?>
                                        ...
                                        <p>
                                            <?php                    
                            $options = get_option( 'consult_options' ); 
                            echo $group_one_value['group_textarea']; 
                            ?>
                                        </p>
                                    </div>
                                </div><!--col-md-4 -->
